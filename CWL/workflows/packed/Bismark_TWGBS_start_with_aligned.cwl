{
    "$graph": [
        ...
        },
        {
            ...
            "inputs": [
                {
                    ...
                    "id": "#samtools_merge_and_sort_doublexes.cwl/bams_doublex1"
                },
                {
                    "type": "File",
                    "inputBinding": {
                    ...
                    "id": "#samtools_merge_and_sort_doublexes.cwl/bams_doublex2"
                },
                {
                    "type": "boolean",
                    "default": false,
                    ...
                    "id": "#samtools_merge_and_sort_doublexes.cwl/name_sort"
                },
                {
                    "type": "int",
                    "default": 1,
                    "id": "#samtools_merge_and_sort_doublexes.cwl/threads"
                }
            ],
            "outputs": [
                {
                    "id": "#samtools_merge_and_sort_doublexes.cwl/bam_merged",
                    "type": "File",
                    "outputBinding": {
            ...
            "id": "#samtools_merge_and_sort_doublexes.cwl"
        },
        {
            "class": "Workflow",
            "requirements": [
            ...
            "steps": [
                ...
                {
                    "run": "#samtools_merge_and_sort_doublexes.cwl",
                    "scatter": [
                        "#main/merge_and_sort_doublexes/bams_doublex1",
                        "#main/merge_and_sort_doublexes/bams_doublex2"
                    ],
                    "scatterMethod": "dotproduct",
                    "in": [
                        {
                            "source": "#main/bams_doublex1",
                            "id": "#main/merge_and_sort_doublexes/bams_doublex1"
                        },
                        {
                            "source": "#main/bams_doublex2",
                            "id": "#main/merge_and_sort_doublexes/bams_doublex2"
                        },
                        {
                            "valueFrom": "$(true)",
                            "id": "#main/merge_and_sort_doublexes/name_sort"
                        },
                        {
                            "source": "#main/threads",
                            "id": "#main/merge_and_sort_doublexes/threads"
                        }
                    ],
                    "out": [
                        "#main/merge_and_sort_doublexes/bam_merged"
                    ],
                    "id": "#main/merge_and_sort_doublexes"
                },
                {
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#main/merge_and_sort_doublexes/bam_merged",
            ...
            "outputs": [
                ...
                {
                    "type": "File",
                    "outputSource": "#main/merge_and_sort/bam_merged",
